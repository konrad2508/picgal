...
class ConcreteImageControllerService(ImageControllerService):
    def __init__(
            self,
    ...
    def get_infos(self, image_url: str, preview_url: str, sample_url: str, tags: str | None, page: int) -> list[ImageData]:
        normal_tag_array, virtual_tag_array = self.converter.convert_tagstring(self.repository.get_conditions, tagstring=tags)
